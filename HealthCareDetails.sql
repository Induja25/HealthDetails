...
create table login(id int,userid int,username varchar(50),pass varchar(15),primary key(id),foreign key(userid) references patient(pat_id));

insert into login(id,userid,username,pass)values(10,1,"Sanju","Ra@12"),(20,2,"Bhuvana","Sa@12"),(30,3,"Induja","Ka@12");
select*from login;
select*from patient;
select userid,username from login where userid=2;